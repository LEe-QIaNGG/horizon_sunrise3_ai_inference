...
class DecoderWithAttention(nn.Module):
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths,predictions,alphas):
        """
        Forward propagation.
        ...
        # Embedding
        encoded_captions=encoded_captions.long()
        ...
        #decode_lengths=caption_lengths.list()-1
        #size2=torch.max(caption_lengths).item()
